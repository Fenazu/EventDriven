...
public class ConsumidorAuditoria {
    ...
    public void processar(EventoPedidoCriado evento) {
        log.info("Auditoria: pedido {} registrado — cliente {}, produto {}, quantidade {}, criadoEm {}",
                evento.idPedido(), evento.idCliente(), evento.idProduto(), evento.quantidade(), evento.criadoEm());
    }
}
